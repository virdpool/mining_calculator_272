...
if(!window.BigInt){
  ...
  window.bn_sub = function(a,b){return a.subtract(b)}
  window.bn_shl = function(a,b){return a.shiftLeft(b)}
}else{
  window.bn_sub = function(a,b){return a-b}
  window.bn_shl = function(a,b){return a<<b}
}